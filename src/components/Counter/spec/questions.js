...
export const incrementButton = () => {
  return PageElement.located(By.css(".counter-increment-btn")).describedAs(
    "counter-increment-btn"
  );
};

export const decrementButton = () => {
  return PageElement.located(By.css(".counter-decrement-btn")).describedAs(
    "counter-decrement-btn"
  );
};

export const counterValue = () => {
  return PageElement.located(By.css(".counter-value")).describedAs(
    "counter-value"
  );
};
